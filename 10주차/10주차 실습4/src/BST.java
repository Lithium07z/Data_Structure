...
public class BST<Key extends Comparable<Key>, Value> {
	...
	public Key kthSmallest(int k) {
		...
		return (Key) addNodeToList(root, list).get(k);
	}

	public boolean checkBST() {
		LinkedList<Key> list = new LinkedList<Key>();
		return checkBST(addNodeToList(this.root, list));
	}
	
	public boolean checkBST(LinkedList list) {
	...
	public LinkedList addNodeToList(Node n, LinkedList list) {
		if (n != null) {
			addNodeToList(n.getLeft(), list);
			list.add((Key) n.getKey());
			addNodeToList(n.getRight(), list);
		}
		return list;
	}
